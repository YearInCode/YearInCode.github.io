...
def get_tastebreaker_repos():
    ...
    for repo in repositories_a[:5]:
        tastebreaker_repos.append(repo)
...
def get_recommended_contribution_repos():
    ...
    for repo in repositories[:10]:
        recommended_contribution_repos.append(repo)
